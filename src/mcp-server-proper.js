...
/**
 * Proper MCP Server for TomTom Maps Integration
 * Follows the Model Context Protocol specification for Le Chat integration
 */
...
class TomTomMCPServer {
  ...
  async run() {
    ...
    console.error('TomTom MCP Server running on stdio');
  }
}

// Start the server
const server = new TomTomMCPServer();
